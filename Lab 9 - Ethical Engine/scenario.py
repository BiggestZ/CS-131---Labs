...
class Person():
    ...
    PROF_TYPES = ["doctor", "CEO", "criminal", "unemployed-poor", "unemployed--wealthy", "unknown", "unknown", "unknown"]
    # Possible genders of humans
    GENDER_TYPES = ["male", "female", "non-binary"]
    ...
    BODYWEIGHT_CHANCE = ["slow", "fast", "average", "average"]
